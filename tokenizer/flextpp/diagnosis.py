# FlexTPP Tokenization Implementation for Diagnosis Codes
...
class DiagnoseTokenizer:
    ...
    def __init__(self, icd_9_10_conversion_map: dict = None):
        ...
        if self.icd_9_10_conversion_map is None:
            ...
            data_file = os.path.join(base_dir, '..', 'data', 'icd_cm_9_to_10_mapping.csv.gz')
    ...
    def _divide_code_into_parts(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        data['tokenized_version'] = '<ICD> <' + code + '>'
        return data
